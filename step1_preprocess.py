...
# read OpenFOAM data
models_lf = ['LF_mesh15_kepsilon','LF_mesh15_koemga','LF_mesh15_laminar']
path_lf = '/home/yangmo/Desktop/thesis/caseC-2-DNS_subchannel/LF_openfoam_newest/'
# get LF features
def getfeatures(path):
    ...
    if os.path.isfile(path+dir_result+'/k'):
        ...
        k[:] = 0
    feature = np.vstack([U.T,gradU.T,dwall.T,k.T]).T
...
# save data
np.savetxt("step1_data_output.csv", data_output)
